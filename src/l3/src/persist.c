                    ...
                    const char *path)
{
    ...
    while (fgets(line, sizeof(line), f)) {
        ...
        vr_json_get_str(line, "prefix",  prefix,  sizeof(prefix));
        vr_json_get_str(line, "nexthop", nexthop, sizeof(nexthop));
        vr_json_get_str(line, "iface",   iface,   sizeof(iface));
        vr_json_get_str(line, "metric",  metric_s,sizeof(metric_s));
        vr_json_get_str(line, "source",  source_s,sizeof(source_s));
        vr_json_get_str(line, "ad",      ad_s,    sizeof(ad_s));
